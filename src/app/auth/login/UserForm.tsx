"use client";
import { CreateAccount, DontHaveAccount, EmailAddress, ForgotPassword, Href, ImagePath, OrSignInWith, Password, RememberPassword, SignIn, SignInToAccount } from "@/Constants";
...
const UserForm = () => {
  ...
  const formSubmitHandle = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await signIn("credentials", {
      ...
      password,
      redirect: false,
      callbackUrl: "/pages/sample-page",
    });

    if (result?.ok) {
      toast.success("successfully Logged in Rediract......");
      router.push("/pages/sample-page");
    } else {
