import { Dashboard, Default, Href } from "@/Constants";
    ...
    <Col xs="auto" className="header-right-wrapper page-title">
      <div>
        ...
        <Breadcrumb className="justify-content-sm-start align-items-center mb-0">
          ...
          <BreadcrumbItem className="f-w-500">{capitalize(second)}</BreadcrumbItem>
          <BreadcrumbItem className="f-w-500">{capitalize(first)}</BreadcrumbItem>
        </Breadcrumb>
      </div>
    </Col>
  );
